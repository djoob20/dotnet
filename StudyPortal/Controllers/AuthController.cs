...
public class AuthController : ControllerBase
{
    ...
    public AuthController(IOptions<StudyPortalDatabaseSettings> settings)
    {
        _settings = settings;
    }
    ...
    [HttpPost(Name="Login")]
        ...
        {
            var user = new AuthUser { UserName = model.UserName, Role = model.Role, BirthDay = model.BirthDay };
